...
9. [Model Context Protocol Specification](https://modelcontextprotocol.io/specification/2025-06-18)：生命周期、Tools、Resources、Prompts 与安全考虑。
10. [Building Effective Agents — Anthropic](https://www.anthropic.com/engineering/building-effective-agents)：workflow、agent、orchestrator-worker、evaluator-optimizer 等模式。
11. [Demystifying evals for AI agents — Anthropic](https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents)：Agent eval 方法。
12. [A Practical Guide to Building Agents — OpenAI](https://openai.com/business/guides-and-resources/a-practical-guide-to-building-ai-agents/)：工具、编排、guardrail 与人工介入。
13. [SWE-bench 论文](https://arxiv.org/abs/2310.06770)：真实 GitHub issue 评测的定义与局限。
14. [SWE-bench Pro](https://arxiv.org/abs/2509.16941)：长时软件工程任务与失败分析。
15. [ReAct](https://arxiv.org/abs/2210.03629)：Reasoning 与 Acting 交替的基础范式。
16. [Lost in the Middle](https://arxiv.org/abs/2307.03172)：长上下文中信息位置与利用问题。
